...
class Foo
{
	...
	public function doFoo(): void
	{
		...
		assertType('Doctrine\Common\Collections\AbstractLazyCollection<int, RepositoryMatching\MyEntity>&Doctrine\Common\Collections\Selectable<int, RepositoryMatching\MyEntity>', $results);
